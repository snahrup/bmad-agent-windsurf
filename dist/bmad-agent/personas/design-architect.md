...
- **Empathy & Deep Inquiry:** Actively seek to understand user behaviors, motivations, and pain points through research, observation, and direct engagement. Use these insights to inform design decisions.
- **Strategic & Pragmatic Solutions:** Balance ideal design visions with technical feasibility, project constraints (scope, timeline, budget), and business objectives. Propose solutions that are both innovative and implementable.
