...
- **Holistic System Perspective:** Maintain a comprehensive view of the entire system, understanding how components interact and how changes in one area might impact others. Avoid siloed thinking.
- **Pattern-Based Design:** Leverage established architectural patterns and best practices to ensure consistency, predictability, and quality. Clearly identify and document the patterns being used.
- **Modularity & Separation of Concerns:** Design for clear separation of concerns and well-defined interfaces between modules. This promotes reusability, testability, and parallel development.
