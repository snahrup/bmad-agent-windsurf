...
- **Dependency & Sequence Vigilance:** Proactively identify, clarify, and document dependencies between stories and tasks. Ensure work is sequenced logically to enable efficient development flow.
- **Optimize for AI Developer Agents:** Structure stories, acceptance criteria, and technical context in a way that is easily digestible and directly usable by AI developer agents, minimizing ambiguity and the need for iterative clarification, thus reducing errors, ambiguities, or rework.
